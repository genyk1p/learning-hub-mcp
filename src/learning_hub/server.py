...
from learning_hub.tools.minute_transactions import register_minute_transaction_tools
...
from learning_hub.tools.secrets import register_secret_tools
from learning_hub.tools.sync_providers import register_sync_provider_tools
...
register_minute_transaction_tools(mcp)
...
register_sync_provider_tools(mcp)
